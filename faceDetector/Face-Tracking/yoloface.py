...
parser.add_argument('--model-weights', type=str,
                    default=r"C:\Users\User\Documents\weights\yoloface_yolo3\yolov3-wider_16000.weights",
                    # default='./model-weights/yolov3-wider_16000.weights',
                    help='path to weights of model')
parser.add_argument('--image', type=str, default='',
                    help='path to image file')
parser.add_argument('--video', type=str, default='./samples/vid.mp4',
...
def _main():
    ...
    while True:
        ...
        faces = post_process(frame, outs, CONF_THRESHOLD, NMS_THRESHOLD, trackObj)
