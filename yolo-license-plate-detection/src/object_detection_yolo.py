...
modelWeights = "/home/yossi/Documents/weights/lpr_yolo3/model.weights" #,"../model/weights/model.weights"
...
def postprocess(frame, outs):
    ...
    for out in outs: # there are 3 outs: (507,6), (2028,6), (8112,6)
        ...
        for detection in out: # detection shape = (8112, 6) = (8112, [center_x, center_y, width, height, Objectness Score, Class Scores])
            ...
            if detection[4] > confThreshold: #Objectness Score
                print(f"{detection[4]=}, - , {classId=}, {scores[classId]=},- th : {confThreshold=}")
            if confidence > confThreshold: # Class Scores]
